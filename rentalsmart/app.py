...
# O caminho absoluto garante que o DB seja criado na pasta correta
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///leads_diagnosticos_v2.db'
...
if __name__ == "__main__":
    ...
    # Rodar o app
    # Usando host=0.0.0.0 para facilitar acesso se necessário
